package com.company.bancoAdapter;

import com.company.structural.adapter.Adapter;
import com.company.structural.adapter.banco.AdapterBanco;
import com.company.structural.adapter.banco.BancoNostrumIml;
import com.company.structural.adapter.banco.InternationalMoneyOrganization;
...
public class InternationMoneyTests {
	...
	public void init() {
		...
		servicio = new AdapterBanco(new BancoNostrumIml());
	}
